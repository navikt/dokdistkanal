...
public class DokDistKanalServiceTest {
	...
	public void shouldSettPrintNavNaarIngenArkivering() throws DokDistKanalFunctionalException, DokDistKanalSecurityException {
		...
		DokDistKanalResponse serviceResponse = service.velgKanal(DOKUMENTTYPEID, FNR, MottakerTypeCode.PERSON, FNR, ER_ARKIVERT_TRUE);
	...
	public void shouldSetKanalPrintNaarOrganisasjon() throws DokDistKanalFunctionalException, DokDistKanalSecurityException {
		...
		DokDistKanalResponse serviceResponse = service.velgKanal(DOKUMENTTYPEID, BRUKERID, MottakerTypeCode.ORGANISASJON, BRUKERID, ER_ARKIVERT_TRUE);
		assertEquals(serviceResponse.getDistribusjonsKanal(), DistribusjonKanalCode.PRINT);
	...
	public void shouldSetKanalPrintNaarSamhandler() throws DokDistKanalFunctionalException, DokDistKanalSecurityException {
		...
		DokDistKanalResponse serviceResponse = service.velgKanal(DOKUMENTTYPEID, FNR, MottakerTypeCode.SAMHANDLER_HPR, FNR, ER_ARKIVERT_TRUE);
		assertEquals(serviceResponse.getDistribusjonsKanal(), DistribusjonKanalCode.PRINT);
	...
	public void shouldSetKanalPrintNaarMottakerIdIkkeErBrukerId() throws DokDistKanalFunctionalException, DokDistKanalSecurityException {
		...
		DokDistKanalResponse serviceResponse = service.velgKanal(DOKUMENTTYPEID, BRUKERID, MottakerTypeCode.PERSON, ANNEN_BRUKERID, ER_ARKIVERT_TRUE);
	...
	public void shouldSetKanaPrintNaarPaalogginsnivaa4OgIkkeSDPOgIkkeArkivert() throws DokDistKanalFunctionalException, DokDistKanalSecurityException {
		...
		DokDistKanalResponse serviceResponse = service.velgKanal(DOKUMENTTYPEID, FNR, MottakerTypeCode.PERSON, FNR, ER_ARKIVERT_FALSE);
		assertEquals(serviceResponse.getDistribusjonsKanal(), DistribusjonKanalCode.PRINT);
