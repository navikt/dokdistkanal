...
public enum BestemDistribusjonskanalRegel {
	...
	ORGANISASJON_MED_ALTINN_INFO(DPVT, "Mottaker er organisasjon, er en gyldig altinn-serviceowner notifikasjonsmottaker og har personer med nødvendig roller"),
	ORGANISASJON_UTEN_ALTINN_INFO(PRINT, "Mottaker er organisasjon og mangler varslingsinformasjon for DPVT, personer med nødvendig roller eller konkurs"),
